...
public class OpenApiServiceImpl implements OpenApiService {
    ...
    @Override
    public OpenAPI combineSpecifications(List<OpenAPI> specs, String basePath, SecurityScheme scheme, String title) {
...
//        final List<SecurityScheme> childSchemes = newArrayList();
